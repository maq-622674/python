...
#要删除指定位置的元素，用pop(i)方法，其中i是索引位置：索引先从0开始
a=classmates.pop(1)
print(a)
print(classmates)
...
'''
classmates = ('Michael', 'Bob', 'Tracy')
#现在，classmates这个tuple不能变了，它也没有append()，insert()
# 这样的方法。其他获取元素的方法和list是一样的，
...
#这个tuple定义的时候有3个元素，
# 分别是'a'，'b'和一个list。不是说tuple一旦定义后就不可变了吗？
# 怎么后来又变了？
#别急，我们先看看定义的时候tuple包含的3个元素：
#表面上看，tuple的元素确实变了，但其实变的不是tuple的元素
# ，而是list的元素。tuple一开始指向的list并没有改成别的list，所以，tuple所谓的“不变”是说，tuple的每个元素，指向永远不变。即指向'a'，就
